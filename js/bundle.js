...
function cards() {
  ...
  // first solution about info from DataBase
  // getResoursce("http://localhost:3000/menu").then((data) => {
  ...
  // second solution about info from DataBase
  (0,_services_services__WEBPACK_IMPORTED_MODULE_0__.getResoursce)("http://localhost:3000/menu").then((data) => {
    createCard(data);
  });
...
function tabs(
  tabsSelector,
  tabsContentSelectior,
  tabsParentSelector,
  activeClass
) {
  // Tabs
  const tabs = document.querySelectorAll(tabsSelector);
  const tabsContent = document.querySelectorAll(tabsContentSelectior);
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])(".timer", "2024-11-10");
